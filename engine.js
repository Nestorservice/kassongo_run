/* ═══════════════════════════════════════════════════════════════
   KASSONGO RUN — engine.js  (Chase-style runner)
   Warthog flees RIGHT, Lion chases from LEFT. Tap=boost.
   ═══════════════════════════════════════════════════════════════ */

export const CONFIG = {
    WEATHER_API_KEY: 'e19f5f4ce30ec1034569ca385306561d', // from OpenWeatherMap
    GRAVITY: 0.55,
    JUMP_FORCE: -13.5,
    BASE_SCROLL: 3,
    MAX_SCROLL: 8,
...
export class AssetLoader {
    ...
    _loadAudio(key, src) {
        return new Promise((resolve) => {
            ...
            audio.oncanplaythrough = () => { this._updateProgress(); resolve(audio); };
