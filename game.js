...
import {
    ...
    Warthog, ChaseLion, RainSystem, ScoreManager, AudioManager
} from './engine.js';
...
class Game {
    ...
    _setupInput() {
        ...
        document.addEventListener('keydown', (e) => {
            if (e.code === 'Space' && this._state === STATE.PLAYING && this._warthog) {
                e.preventDefault();
                this._warthog.accelerate();
            }
        });
    ...
    _loop(timestamp) {
        ...
        if (this._state === STATE.PLAYING) {
            ...
            /* Scroll speed scales with boost */
            this._scrollSpeed = CONFIG.BASE_SCROLL + this._warthog.boost * 0.8;
